...
Stack buildRocketIcon(double size) {
  return Stack(children: [
    Icon(const IconData(0xe938, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e938_e93b_e94b, size: size),
    Icon(const IconData(0xe939, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e939_e93a_e944, size: size),
    Icon(const IconData(0xe93a, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e939_e93a_e944, size: size),
    Icon(const IconData(0xe93b, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e938_e93b_e94b, size: size),
    Icon(const IconData(0xe93c, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e93c, size: size),
    Icon(const IconData(0xe93d, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e93d, size: size),
    Icon(const IconData(0xe93e, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e93e, size: size),
    Icon(const IconData(0xe93f, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e93f, size: size),
    Icon(const IconData(0xe940, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e940_e949, size: size),
    Icon(const IconData(0xe941, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e941, size: size),
    Icon(const IconData(0xe942, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e942, size: size),
    Icon(const IconData(0xe943, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e943, size: size),
    Icon(const IconData(0xe944, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e939_e93a_e944, size: size),
    Icon(const IconData(0xe945, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e945_e946, size: size),
    Icon(const IconData(0xe946, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e945_e946, size: size),
    Icon(const IconData(0xe947, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e947, size: size),
    Icon(const IconData(0xe948, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e948, size: size),
    Icon(const IconData(0xe949, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e940_e949, size: size),
    Icon(const IconData(0xe94a, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e94a, size: size),
    Icon(const IconData(0xe94b, fontFamily: 'icomoon'),
        color: Palette.rocketIco_e938_e93b_e94b, size: size),
    Icon(const IconData(0xe94c, fontFamily: 'icomoon'),
        color: Palette.white, size: size),
    Icon(const IconData(0xe94d, fontFamily: 'icomoon'),
        color: Palette.white, size: size),
    Icon(const IconData(0xe94e, fontFamily: 'icomoon'),
        color: Palette.white, size: size),
    Icon(const IconData(0xe94f, fontFamily: 'icomoon'),
        color: Palette.white, size: size),
    Icon(const IconData(0xe950, fontFamily: 'icomoon'),
        color: Palette.white, size: size),
  ]);
}
